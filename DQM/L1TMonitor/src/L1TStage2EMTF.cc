...
*/
    ...
    double minValue = emtfChamberStrip_QT[hist_index]->getTH1()->GetMinimum() + 1; 
    double maxValue = emtfChamberStrip_QT[hist_index]->getTH1()->GetMaximum() + 1;
...
//        sumChamberStrip += sqrt(emtfChamberStrip_QT[hist_index]->getTH1()->GetBinContent(binX, binY));
        ...
        sumChamberStrip += sqrt((emtfChamberStrip_QT[hist_index]->getTH1()->GetBinContent(binX, binY) + 1 - minValue)/(maxValue - minValue));
      }
    }
...
//	emtfChamberStrip_QT_hot[hist_index]->getTH1()->SetBinContent(binX, binY, 1 - meanChamberStrip + sqrt(emtfChamberStrip_QT[hist_index]->getTH1()->GetBinContent(binX, binY))); 
	...
	emtfChamberStrip_QT_dead[hist_index]->getTH1()->SetBinContent(binX, binY, 1 + meanChamberStrip - sqrt((emtfChamberStrip_QT[hist_index]->getTH1()->GetBinContent(binX, binY) + 1 - minValue)/(maxValue - minValue)));
	emtfChamberStrip_QT_hot[hist_index]->getTH1()->SetBinContent(binX, binY, 1 - meanChamberStrip + sqrt((emtfChamberStrip_QT[hist_index]->getTH1()->GetBinContent(binX, binY) + 1 - minValue)/(maxValue - minValue))); 
      }
    }
/*
    for (int binX=1; binX <= xMax; binX++) {
